...
export const metadata: Metadata = { title: 'MElocalmarketplace' }
...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-muted/40 p-6">
      ...
      <Link href="/" className="group relative mb-6 flex max-w-full items-center gap-2">
        ...
        <span className="truncate font-serif text-2xl leading-none tracking-tight text-foreground">MElocalmarketplace</span>
      </Link>
