    ...
    <div className="p-6 max-w-[1600px] mx-auto space-y-6 bg-zinc-50 min-h-[calc(100vh-4rem)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-4 shadow-sm border-l-4 border-l-amber-500">
          <span className="text-[10px] font-bold text-amber-600 uppercase tracking-wider block">4. Monthly OpEx</span>
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider block">6. Net Profit Margin</span>
      ...
      {/* CHARTS DISPLAY OVERLAYS */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-zinc-200 rounded-xl p-5 shadow-sm">
          <h3 className="text-xs font-bold text-zinc-800 uppercase tracking-wider mb-4">Sales Volatility Timeline</h3>
            ...
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="border-b border-zinc-100 text-zinc-400 uppercase font-bold bg-zinc-50/50">
                  ...
                  <th className="p-3 text-right">Net Profit Yield</th>
                </tr>
              </thead>
